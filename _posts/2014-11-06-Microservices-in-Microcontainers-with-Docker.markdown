...
The linked libraries of an executable can be checked with the `ldd` command. I installed node on the host and running `ldd` there gives the following result:
